...
function App() {
  ...
  const trim =
    search.get("trim") === "time"
      ? "time"
      : search.get("trim") === "date"
      ? "date"
      : undefined;
  const second =
    search.get("second") === "true" ? ("numeric" as const) : undefined;
  ...
  const textAlign =
    (search.get("textAlign") as CSSProperties["textAlign"]) || undefined; //todo: TYPE BETTER because default goes to left
                  ...
                  control={
                    <Checkbox
                      ...
                      onChange={(
                        ...
                        checked: boolean
                      ) => handleChange(event, checked, "trim")}
                    />
                  }
                  label={"Time Only"}
                />
                  ...
                  control={
                    <Checkbox
                      ...
                      onChange={(
                        event: ChangeEvent<HTMLInputElement>,
                        checked: boolean
                      ) => handleChange(event, checked, "twoLines")}
                    />
                  }
                  label={"Two Lines"}
                />
                  ...
                  control={
                    <Checkbox
                      ...
                      onChange={(
                        event: ChangeEvent<HTMLInputElement>,
                        checked: boolean
                      ) => handleChange(event, checked, "timeFirst")}
                    />
                  }
                  label={"Time First"}
                />
